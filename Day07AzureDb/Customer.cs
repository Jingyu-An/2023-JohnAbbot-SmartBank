...
namespace Day07AzureDb
{
    public class Customer
    {
        ...
        public Customer(string email, string full_name, string phone_number, string password, string address, DateTime created_at, string account_type, int account_balance)
        {
            Email = email;
            Full_name = full_name;
